...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://hemanth-ranam-website.hemanth-ranam.workers.dev"),
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://hemanth-ranam-website.hemanth-ranam.workers.dev",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Person",
        "@id": "https://hemanth-ranam-website.hemanth-ranam.workers.dev/#person",
        name: "Hemanth Ranam",
        ...
        image: "https://hemanth-ranam-website.hemanth-ranam.workers.dev/images/hemanth-ranam-profile.jpg",
        alumniOf: [
          {
      ...
      },
      {
        ...
        "@id": "https://hemanth-ranam-website.hemanth-ranam.workers.dev/#service",
