...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-12 md:py-20 bg-slate-50/50 border-t border-slate-200/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 gap-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-600 font-medium">
              Clear, affordable milestone-based pricing in USD ($). No hourly billing, no hidden retainers.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {selectedPricingGroup.items.map((item) => (
            ...
            >
              <div>
                {/* Header: Service Name & Was/From Price */}
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-2xs transition-colors"
                >
                  <span>Discuss</span>
