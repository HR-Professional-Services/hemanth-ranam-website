...
export function Hero() {
  return (
    <section className="relative pt-6 pb-14 sm:pt-10 sm:pb-18 lg:pt-14 lg:pb-22 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[480px] bg-gradient-to-b from-blue-100/60 via-indigo-50/40 to-transparent pointer-events-none blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mt-4 sm:mt-5">
          ...
          <div className="mt-5 sm:mt-6 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            ...
            <a
              href="#trading-tech"
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-indigo-50/90 border border-indigo-200 hover:bg-indigo-100/80 text-indigo-800 text-xs font-semibold transition-all group shadow-sm"
            >
              <div className="w-6 h-6 rounded-lg bg-indigo-600 text-white flex items-center justify-center shrink-0">
                <TrendingUp className="w-3.5 h-3.5" />
              </div>
              <span>02 Trading Technology</span>
              <span className="text-[10px] bg-indigo-200/70 text-indigo-800 px-1.5 py-0.5 rounded font-mono font-bold">Pine &amp; MT5</span>
            </a>
          </div>
          ...
          <div className="mt-6 sm:mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              href="#trading-tech"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full text-xs sm:text-sm font-bold text-slate-700 hover:text-indigo-700 bg-white hover:bg-slate-50 border border-slate-200 shadow-sm transition-all hover:scale-[1.02]"
            >
          ...
          <div className="mt-7 pt-5 border-t border-slate-200/80 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-3xl mx-auto text-center">
            ...
            <div className="p-2.5 rounded-xl bg-white border border-slate-200 shadow-sm">
              <div className="text-base sm:text-lg font-bold text-indigo-600 font-mono">&lt; 120ms</div>
              <div className="text-[11px] text-slate-500 font-medium">MT5 Execution</div>
            </div>
          </div>
        </div>
