      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3 shrink-0 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-500 p-[1.5px] shadow-md shadow-blue-500/20 group-hover:shadow-blue-500/35 transition-all">
              <div className="w-full h-full bg-white rounded-[10px] flex items-center justify-center">
                <span className="font-extrabold text-sm tracking-wider bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                  HR
                </span>
              </div>
            </div>
          ...
          <nav className="hidden md:flex items-center gap-1 lg:gap-1.5">
            ...
            >
              ...
              {/* Flyout Menu Panel (Pure White Glass) */}
              {businessOsOpen && (
                  ...
                  <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-2xl shadow-slate-400/20 backdrop-blur-2xl">
                    <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100">
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200 font-semibold">
                          01 Division
                        </span>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Link
                        ...
                        className="p-2.5 rounded-xl hover:bg-blue-50/60 transition-colors group/item"
                      >
                    ...
                    <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px]">
                      <div className="flex items-center gap-1.5 text-slate-600 font-medium">
                        ...
                        <span>Managed setup + continuous maintenance</span>
                      </div>
                      <Link
                        href="/#products"
                        onClick={() => setBusinessOsOpen(false)}
            ...
            <Link
              href="/#digital-growth"
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs lg:text-sm font-medium text-slate-700 hover:text-blue-600 rounded-full hover:bg-slate-100/70 transition-all whitespace-nowrap"
            >
            ...
            <Link
              href="/#trading-tech"
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs lg:text-sm font-medium text-slate-700 hover:text-indigo-600 rounded-full hover:bg-slate-100/70 transition-all whitespace-nowrap"
            >
            ...
            <Link
              href="/#how-it-works"
              className="px-3 py-1.5 text-xs lg:text-sm font-medium text-slate-700 hover:text-blue-600 rounded-full hover:bg-slate-100/70 transition-all whitespace-nowrap"
            >
              How It Works
            </Link>
          ...
          <div className="hidden sm:flex items-center gap-2.5 shrink-0">
            {/* WhatsApp Quick Link (opens in same tab as requested, no phone displayed) */}
            <a
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold text-emerald-700 hover:text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 transition-all whitespace-nowrap shadow-sm"
            ...
            {/* Book Consultation Primary CTA (Rich Blue Gradient) */}
            <a
              href="#contact"
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-bold text-white bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 shadow-md shadow-blue-500/25 border border-blue-400/20 transition-all hover:scale-[1.02] whitespace-nowrap"
            >
          ...
          <div className="md:hidden flex items-center gap-2">
            <a
              href="#contact"
              className="px-3 py-1.5 rounded-full text-xs font-bold text-white bg-blue-600 hover:bg-blue-500"
            >
              Consult
            </a>
            <button
              ...
              className="p-1.5 text-slate-700 hover:text-blue-600 rounded-lg focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-slate-200 bg-white/98 backdrop-blur-2xl px-4 pt-3 pb-6 space-y-3 shadow-xl animate-in fade-in slide-in-from-top-2 duration-150">
          ...
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            <a
              href="https://wa.me/917675815245?text=Hi%20Hemanth%2C%20I%20would%20like%20to%20discuss%20a%20Business%20OS%20for%20my%20company."
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-xs font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 shadow-sm"
            >
