  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          "TypeScript, Next.js & responsive modern UI",
      ...
      {
        id: "plan-api-webhook-integration",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        serviceId: "tradingview-strategies",
        slug: "tradingview-strategies",
        categoryLabel: "Trading Technology",
      },
      {
        id: "plan-mt5-custom-indicator",
      ...
      {
        id: "plan-trading-alerts-telegram",
        ...
        serviceId: "telegram-trading-alerts",
        slug: "telegram-trading-alerts",
        categoryLabel: "Trading Technology",
      },
      {
        id: "plan-mt5-expert-advisor",
        ...
        serviceId: "mt5-auto-trading",
        slug: "mt5-auto-trading",
        categoryLabel: "Trading Technology",
      },
      {
        id: "plan-trading-automation-setup",
...
export interface CommercialPlan {
  id: string;
  name: string;
  category: "Business & Consulting" | "Software & Web" | "Trading Technology";
...
export const STRIPE_CONFIG = {
  ...
  paymentLinks: {
    ...
    processTechAudit: "",
    businessSystemsConsulting: "",
    workflowAutomation: "",
    crmErpImplementation: "",
    websiteBasicMonthly: "",
    websitePremiumMonthly: "",
    websiteAutomationMonthly: "",
    crmStarterMonthly: "",
    crmGrowthMonthly: "",
    businessSystemsGrowthMonthly: "",
    businessSystemsCustomMonthly: "",
    tradingStandardMonthly: "",
    tradingCustomMonthly: "",
    tradingAutomationMonthly: "",
  },
};

export const ONE_TIME_PROJECT_PLANS: CommercialPlan[] = [
  {
    id: "plan-biz-consultation",
...
export const MONTHLY_SUBSCRIPTION_PLANS: CommercialPlan[] = [
  {
    id: "sub-website-basic",
    name: "Website Basic",
    ...
    period: "/month",
    currency: "USD",
    description: "Fast, responsive business landing page with SSL, domain routing and lead capture.",
    bullets: [
      "Mobile-optimized high performance responsive layout",
      "Contact form with instant WhatsApp & email notification",
      "Continuous security patches, uptime monitoring & hosting",
    ],
    slug: "websites",
    badge: "Monthly Plan",
    serviceId: "websites",
  ...
  },
  {
    ...
    period: "/month",
    currency: "USD",
    description: "Multi-section custom web platform with conversion optimization and structured SEO.",
    bullets: [
      "Tailored UI components, micro-animations & CMS",
      "Full SEO schema markup, OpenGraph & social cards",
      "Monthly content updates & speed performance maintenance",
    ],
    slug: "websites",
  ...
  },
  {
    ...
    period: "/month",
    currency: "USD",
    description: "Automated web platform connected directly to Google Sheets CRM and notification bots.",
    bullets: [
      "Automatic lead capture into Google Sheets CRM",
      "Dual email confirmation (Admin alert + Customer receipt)",
      "Continuous webhook health monitoring & automated backups",
    ],
  ...
  },
  {
    ...
    period: "/month",
    currency: "USD",
    description: "Lightweight CRM solution capturing every customer interaction with zero per-seat fees.",
    bullets: [
      "Centralized lead & customer contact records",
      "Deal pipeline tracking with customizable stages",
      "Google Workspace & mobile WhatsApp integration",
    ],
    slug: "website-lead-capture-crm",
    badge: "Essential",
    serviceId: "website-lead-capture-crm",
  ...
  {
    id: "sub-business-systems-growth",
    name: "Business Systems Growth",
    category: "Business & Consulting",
    billing: "monthly",
    price: "$149",
    period: "/month",
    currency: "USD",
    description: "Continuous ERP/CRM management, custom DocType tweaks, and monthly workflow automations.",
    bullets: [
      "Frappe / ERPNext server updates and database optimization",
      "Ongoing SOP adjustments, print format tweaks & permissions",
      "Priority WhatsApp technical support with 24-hour turnaround",
    ],
    slug: "frappe-erpnext",
  ...
  },
  {
    ...
    period: "/month",
    currency: "USD",
    description: "Access to private Pine Script v5 indicators with non-repainting signal logic.",
    bullets: [
      "Non-repainting rule-based indicators on TradingView",
      "Custom multi-timeframe confirmation alerts",
      "Continuous indicator updates and parameter tuning",
    ],
    slug: "tradingview-indicators",
  ...
  },
  {
    ...
    period: "/month",
    currency: "USD",
    description: "MetaTrader 5 custom scanner, automated execution EA support, and sub-second Telegram bridge.",
    bullets: [
      "Multi-symbol 28-pair scanner monitoring market conditions",
      "Sub-second trade signal broadcast to private Telegram channel",
      "MQL5 EA VPS monitoring, risk guardrail checks & updates",
    ],
    slug: "telegram-trading-alerts",
